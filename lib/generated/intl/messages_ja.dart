...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "canNotCreateOrder": MessageLookupByLibrary.simpleMessage("オーダーを作成できません"),
    ...
    "chatViaFacebook": MessageLookupByLibrary.simpleMessage(
      "Facebookメッセンジャー経由でチャット",
    ),
    "chatViaWhatApp": MessageLookupByLibrary.simpleMessage("WhatsApp経由でチャット"),
    ...
    "createVariants": MessageLookupByLibrary.simpleMessage("すべてのバリアントを作成する"),
    ...
    "distance": m8,
    "doNotAnyTransactions": MessageLookupByLibrary.simpleMessage("まだ取引はありません"),
    ...
    "emptyComment": MessageLookupByLibrary.simpleMessage("コメントを空にすることはできません"),
    ...
    "enterYourFirstName": MessageLookupByLibrary.simpleMessage("名を入力してください"),
    ...
    "enterYourPhone": MessageLookupByLibrary.simpleMessage("電話番号を入力して開始します。"),
    ...
    "firstComment": MessageLookupByLibrary.simpleMessage("この投稿に最初にコメントしてください！"),
    ...
    "generatingLink": MessageLookupByLibrary.simpleMessage("リンクを生成しています..."),
    ...
    "noBlog": MessageLookupByLibrary.simpleMessage("申し訳ありませんが、このブログは存在しません"),
    ...
    "noForwardHistoryItem": MessageLookupByLibrary.simpleMessage("次の履歴はありません"),
    "noInternetConnection": MessageLookupByLibrary.simpleMessage("インターネット接続なし"),
    "noListingNearby": MessageLookupByLibrary.simpleMessage("近くにリストはありません！"),
    ...
    "noPost": MessageLookupByLibrary.simpleMessage("申し訳ありませんが、このページは存在しません！"),
    ...
    "orderStatusCanceledReversal": MessageLookupByLibrary.simpleMessage("取消取消"),
    ...
    "pasteYourImageUrl": MessageLookupByLibrary.simpleMessage("画像のURLを貼り付けます"),
    ...
    "pointMsgConfigNotFound": MessageLookupByLibrary.simpleMessage(
      "サーバーに割引ポイントの構成が見つかりませんでした",
    ),
    "pointMsgEnter": MessageLookupByLibrary.simpleMessage("割引ポイントを入力してください"),
    "pointMsgMaximumDiscountPoint": MessageLookupByLibrary.simpleMessage(
      "最大割引ポイント",
    ),
    "pointMsgNotEnough": MessageLookupByLibrary.simpleMessage(
      "十分な割引ポイントがありません。合計割引ポイントは",
    ),
    ...
    "productNeedAtLeastOneVariation": MessageLookupByLibrary.simpleMessage(
      "製品型変数には少なくとも1つのバリアントが必要です",
    ),
    "productNeedNameAndPrice": MessageLookupByLibrary.simpleMessage(
      "シンプルな商品タイプには名前と通常価格が必要です",
    ),
    "productOutOfStock": MessageLookupByLibrary.simpleMessage("在庫切れの商品があります"),
    ...
    "refundOrderFailed": MessageLookupByLibrary.simpleMessage(
      "注文の払い戻しのリクエストは失敗しました",
    ),
    "refundOrderSuccess": MessageLookupByLibrary.simpleMessage(
      "ご注文の払い戻しを正常にリクエストしてください。",
    ),
    ...
    "registerAsVendor": MessageLookupByLibrary.simpleMessage("ベンダーユーザーとして登録する"),
    ...
    "sendSMStoVendor": MessageLookupByLibrary.simpleMessage("ストアオーナーにSMSを送信"),
    ...
    "speechNotAvailable": MessageLookupByLibrary.simpleMessage("スピーチは利用できません"),
    ...
    "storeMobileBanner": MessageLookupByLibrary.simpleMessage("モバイルバナーを保存する"),
    "storeSettings": MessageLookupByLibrary.simpleMessage("ストア設定"),
    "storeSliderBanner": MessageLookupByLibrary.simpleMessage("スライダーバナーを保存する"),
    ...
    "viewOnGoogleMaps": MessageLookupByLibrary.simpleMessage("Google マップで見る"),
    "viewRecentTransactions": MessageLookupByLibrary.simpleMessage("最近の取引を見る"),
