...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(currency) => "${currency} haitumiki";

  static String m7(day) => " siku${day} zilizopita";

  static String m8(total) => "~${total} kilomita";

  static String m9(timeLeft) => "Inaisha baada ya ${timeLeft}";

  static String m10(captcha) => "Weka ${captcha} ili kuthibitisha:";

  static String m11(message) => "Hitilafu: ${message}";

  static String m12(time) => "Inaisha baada ya ${time}";

  static String m13(total) => "> kilomita${total} ";

  static String m14(hour) => " saa${hour} zilizopita";
  ...
  static String m17(size) => "Upeo wa ukubwa wa faili: ${size} MB";

  static String m18(currency, amount) =>
      "Kiasi cha chini kabisa cha kutumia malipo haya ni {${currency}} {${amount}}";

  static String m19(minute) => " dakika${minute} zilizopita";

  static String m20(month) => " Miezi${month} iliyopita";

  static String m21(store) => "Zaidi kutoka kwa ${store}";

  static String m22(itemCount) => "${itemCount} vitu";

  static String m23(price) => "Jumla ya chaguo: ${price}";

  static String m24(total) => "Kiasi: ${total}";

  static String m25(percent) => "Uuzaji ${percent}%";

  static String m26(second) => " sekunde${second} zilizopita";

  static String m27(totalCartQuantity) =>
      "Rukwama ya ununuzi, ${totalCartQuantity} vitu";

  static String m28(numberOfUnitsSold) => "Zinauzwa: ${numberOfUnitsSold}";

  static String m29(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m30(total) => "${total} bidhaa";
  ...
  static String m32(date) => "Inatumika hadi ${date}";

  static String m33(message) => "Onyo: ${message}";
  ...
  static String m35(length) => "Tulipata bidhaa ${length} ";

  static String m36(week) => "Wiki ${week}";

  static String m37(name) => "Karibu ${name}";

  static String m38(year) => " miaka${year} iliyopita";

  static String m39(total) => "Umekabidhi kuagiza #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "agreeWithPrivacy": MessageLookupByLibrary.simpleMessage("Faragha na Muda"),
    ...
    "availablePoints": m2,
    "averageRating": MessageLookupByLibrary.simpleMessage("Ukadiriaji Wastani"),
    ...
    "changePrinter": MessageLookupByLibrary.simpleMessage("Badilisha Printer"),
    ...
    "chatViaWhatApp": MessageLookupByLibrary.simpleMessage(
      "Zungumza kupitia WhatsApp",
    ),
    "chatWithBot": MessageLookupByLibrary.simpleMessage("Piga gumzo na Bot"),
    ...
    "createVariants": MessageLookupByLibrary.simpleMessage("Unda anuwai zote"),
    ...
    "dateOldest": MessageLookupByLibrary.simpleMessage("Tarehe: Mzee zaidi"),
    ...
    "dontHaveAccount": MessageLookupByLibrary.simpleMessage("Hauna akaunti?"),
    ...
    "enableForLogin": MessageLookupByLibrary.simpleMessage("Washa kwa Kuingia"),
    "enableForWallet": MessageLookupByLibrary.simpleMessage("Washa kwa Wallet"),
    ...
    "instantlyClose": MessageLookupByLibrary.simpleMessage("Karibu mara moja"),
    ...
    "moreFromStore": m21,
    "moreInformation": MessageLookupByLibrary.simpleMessage("Taarifa zaidi"),
    ...
    "orderStatusCancelled": MessageLookupByLibrary.simpleMessage("Imefutwa"),
    ...
    "orderStatusProcessing": MessageLookupByLibrary.simpleMessage("Inasindika"),
    ...
    "postProduct": MessageLookupByLibrary.simpleMessage("Bidhaa ya Chapisha"),
    ...
    "privacyAndTerm": MessageLookupByLibrary.simpleMessage("Faragha na Vigezo"),
    ...
    "productOutOfStock": MessageLookupByLibrary.simpleMessage(
      "Kuna bidhaa nje ya hisa",
    ),
    "productRating": MessageLookupByLibrary.simpleMessage("Ukadiriaji wako"),
    "productReview": MessageLookupByLibrary.simpleMessage("Uhakiki wa Bidhaa"),
    ...
    "resetPassword": MessageLookupByLibrary.simpleMessage("Rudisha Nenosiri"),
    ...
    "searchForItems": MessageLookupByLibrary.simpleMessage("Tafuta Vipengee"),
    ...
    "selectThePoint": MessageLookupByLibrary.simpleMessage("Chagua uhakika"),
    "selectTheQuantity": MessageLookupByLibrary.simpleMessage("Chagua wingi"),
    ...
    "shortDescription": MessageLookupByLibrary.simpleMessage("Maelezo Fupi"),
    "showAllMyOrdered": MessageLookupByLibrary.simpleMessage(
      "Onyesha Vyote Vilivyoagizwa",
    ),
    ...
    "storeInformation": MessageLookupByLibrary.simpleMessage("Hifadhi Habari"),
    "storeListBanner": MessageLookupByLibrary.simpleMessage(
      "Bango la Orodha ya Hifadhi",
    ),
    "storeLocation": MessageLookupByLibrary.simpleMessage("Mahali pa Hifadhi"),
    "storeLogo": MessageLookupByLibrary.simpleMessage("Nembo ya Hifadhi"),
    "storeMobileBanner": MessageLookupByLibrary.simpleMessage(
      "Hifadhi Bango la Simu",
    ),
    ...
    "updateUserInfor": MessageLookupByLibrary.simpleMessage("Sasisha Profaili"),
    ...
    "vendorInfo": MessageLookupByLibrary.simpleMessage("Maelezo ya muuzaji"),
